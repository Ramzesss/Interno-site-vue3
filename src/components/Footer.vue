<template>
    <footer class="footer__items center">
        <div class="footer__columns">
            ...
            <div class="footer__columns-contact">
                <h3 class="footer__contact-name">Contact</h3>
                <p class="footer__address">55 East Birchwood Ave. Brooklyn, New York 11201 </p>
                <p class="footer__mail">contact@interno.com</p>
